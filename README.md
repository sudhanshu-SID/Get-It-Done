...
### 4. Automated Rewards & Consequences
...
- **Strikes & Consequences:** (WIP) Falling behind on required tasks will issue strikes to your account. Hitting strike limits enforces predefined consequences.
...
- **Automated Strike Enforcement Engine:** Background jobs to issue daily strikes for incomplete mandatory tasks.
